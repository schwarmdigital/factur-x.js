import { CURRENCY_ID, DateTimeType } from "../udt/types";
...
export enum DocumentCodeContentType {
    ...
    OPTICAL_CHARACTER_READING_PAYMENT_CREDIT_NOTE = "420",
    DEBIT_ADVICE = "456",
...
export type DocumentCodeType = DocumentCodeContentType;
