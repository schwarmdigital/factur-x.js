/*
 * Generated type guards for "MinimumProfile.ts".
...
export function isMinimumProfile(obj: unknown, argumentName = 'minimumProfile'): obj is MinimumProfile {
    ...
    return (
        ...
        evaluate(
            ...
            `${argumentName}["meta"]`,
            '{ businessProcessType?: string | undefined; guidelineSpecifiedDocumentContextParameter: "urn:factur-x.eu:1p0:minimum"; }',
            typedObj['meta']
        ) &&
        evaluate(
        ...
        evaluate(
            ...
            `${argumentName}["buyer"]`,
            '{ reference?: string | undefined; name: string; specifiedLegalOrganization?: import("./src/types/udt/IDTypeWithSchemeConverter").IDTypeWithScheme | undefined; orderReference?: string | undefined; }',
            typedObj['buyer']
        ) &&
        evaluate(
