/*
 * Generated type guards for "MinimumProfileXml.ts".
...
export function isMinimumProfileXml(obj: unknown, argumentName = 'minimumProfileXml'): obj is MinimumProfileXml {
    const typedObj = obj as MinimumProfileXml
    return (
        ...
        evaluate(
            ((typedObj['rsm:CrossIndustryInvoice'] !== null &&
                ...
                evaluate(
                        ...
                        evaluate(
                            ((typedObj['rsm:CrossIndustryInvoice']['rsm:ExchangedDocumentContext'][
                                ...
                                evaluate(
                                    ...
                                    '{ \'#text\': "urn:factur-x.eu:1p0:minimum"; }',
                                    typedObj['rsm:CrossIndustryInvoice']['rsm:ExchangedDocumentContext'][
                                        'ram:GuidelineSpecifiedDocumentContextParameter'
                                    ]['ram:ID']
                                ),
                    ...
                    "{ 'ram:BusinessProcessSpecifiedDocumentContextParameter'?: { 'ram:ID': { '#text': string; }; } | undefined; 'ram:GuidelineSpecifiedDocumentContextParameter': { 'ram:ID': { '#text': \"urn:factur-x.eu:1p0:minimum\"; }; }; }",
                    typedObj['rsm:CrossIndustryInvoice']['rsm:ExchangedDocumentContext']
                ) &&
                evaluate(
                    ...
                    "{ 'ram:ID': { '#text': string; }; 'ram:TypeCode': { '#text': string; }; 'ram:IssueDateTime': { 'udt:DateTimeString': { '#text': string; '@format': string; }; }; }",
                    typedObj['rsm:CrossIndustryInvoice']['rsm:ExchangedDocument']
                ) &&
                evaluate(
                        ...
                        evaluate(
                            ((typedObj['rsm:CrossIndustryInvoice']['rsm:SupplyChainTradeTransaction'][
                                ...
                                evaluate(
                                    ((typedObj['rsm:CrossIndustryInvoice']['rsm:SupplyChainTradeTransaction'][
                                        ...
                                        evaluate(
                                            ...
                                            "{ 'ram:ID': { '#text': string; '@schemeID': string; }; } | undefined",
                                            typedObj['rsm:CrossIndustryInvoice']['rsm:SupplyChainTradeTransaction'][
                                                'ram:ApplicableHeaderTradeAgreement'
                                    ...
                                    "{ 'ram:Name': { '#text': string; }; 'ram:SpecifiedLegalOrganization'?: { 'ram:ID': { '#text': string; '@schemeID': string; }; } | undefined; 'ram:PostalTradeAddress': { 'ram:CountryID': { '#text': string; }; }; 'ram:SpecifiedTaxRegistration': [{ 'ram:ID': { '#text': string; '@schemeID': string; }; }, ({ 'ram:ID': { '#text': string; '@schemeID': string; }; } | undefined)?]; }",
                                    typedObj['rsm:CrossIndustryInvoice']['rsm:SupplyChainTradeTransaction'][
                                        'ram:ApplicableHeaderTradeAgreement'
                                    ]['ram:SellerTradeParty']
                                ) &&
                                evaluate(
                                    ...
                                    "{ 'ram:Name': { '#text': string; }; 'ram:SpecifiedLegalOrganization'?: { 'ram:ID': { '#text': string; '@schemeID': string; }; } | undefined; }",
                                    typedObj['rsm:CrossIndustryInvoice']['rsm:SupplyChainTradeTransaction'][
                                        'ram:ApplicableHeaderTradeAgreement'
                                    ]['ram:BuyerTradeParty']
                                ) &&
